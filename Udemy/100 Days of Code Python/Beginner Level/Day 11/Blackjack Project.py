...
while play:
    ...
    print(f'Player hand {user_cards}')
    print(f'Dealer hand {computer_cards[0]}')
    
    hit = input('Would you like to hit? Type "y" to hit or "n" to pass.\n').lower()
    while hit == "y":
        user_cards.append(draw_card())
        ...
        if sum(user_cards) > 21:
            ...
            repeat = input('Would you like to hit? Type "y" to hit or "n" to pass.\n').lower()
        if repeat == "n":
            hit = "n"
    ...
    while hit == 'n':
        if sum(computer_cards) < 17:
            computer_cards.append(draw_card())
        elif 17 < sum(computer_cards) and sum(computer_cards) < 21:
            risk = ('y','n')
    ...
    if computer_score > 21:
        print(f'Dealer hand {computer_cards}. BUSTED!')
        again = input('You win! Would you like to play again? "y" or "n"\n').lower()
    elif user_score > 21:
        print(f'Player hand {user_cards}. BUSTED!')
        again = input('You Lose! Would you like to play again? "y" or "n"\n').lower()
    elif computer_score == 21:
        again = input(f'Dealer has a Black Jack {sum(computer_score)}. You Lose. Would you like to play again? "y" or "n"\n').lower()
    elif user_score == 21:
        again = input(f'Player has a Black Jack {sum(user_score)}. You Lose. Would you like to play again? "y" or "n"\n').lower()
    elif computer_score == user_score:
        print(f'Player hand {user_cards}')
        print(f'Dealer hand {computer_cards}')
        again = input(f"It's a draw. Would you like to play again? 'y' or 'n'\n").lower()
